...
// human_readable-readable strings. This allows conversion to decimal and binary formats.
//
// See: https://en.m.wikipedia.org/wiki/Byte#Multiple-byte_units
//
// @Author: m-manu https://github.com/m-manu
// @Origin: https://github.com/m-manu/go-find-duplicates/blob/main/bytesutil/human_readable_size.go
...
// BinaryFormat formats a byte size to a human_readable readable string in binary format.
...
// DecimalFormat formats a byte size to a human_readable readable string in decimal format.
